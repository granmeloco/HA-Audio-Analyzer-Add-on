...
.trigger-grid{display:grid;grid-template-columns:140px 130px 180px 130px 180px 130px;gap:10px;align-items:center;margin-bottom:10px}
.trigger-grid.header{font-weight:normal;font-size:12px;margin-bottom:12px}
.trigger-grid input{width:120px}
